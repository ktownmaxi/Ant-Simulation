...
class AntCollection:
    ...
    def load_assets(self) -> tuple[pygame.Surface, pygame.Surface]:
    ...
    def create_ant_collection(self, number_of_ants, pos) -> list[Ant]:
        ant_collection = []
    ...
    def getAntCollection(self) -> list[Ant]:
    ...
    def get_spawned_ants(self) -> int:
        return self.spawned_ants
